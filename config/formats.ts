...
export const Formats: FormatList = [
	...
	
	{
		...
		ruleset: ['Standard NatDex', 'OHKO Clause', 'Evasion Moves Clause', 'Species Clause', 'Dynamax Clause', 'Sleep Clause Mod', 'Anti-Invulnerability Mod', 'Z-Moves Clause', 'Movexit Clause'],
		mod: 'conniecorddraft',
		banlist: [

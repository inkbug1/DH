export const Pokedex: {[speciesid: string]: ModdedSpeciesData} = {
	...
	regidrago: {
		...
		abilities: {0: "Dragon Overflow", 1: "Dragon's Maw", H: "Minus"},
		allAbilities: true, 
		heightm: 2.1,
		weightkg: 200,
		color: "Green",
	...
	masquerega: {
		num: 9.9, 
		name: "Masquerega", 
		fusion: ["Masquerain", "Yanmega"], 
		types: ["Bug", "Flying"], 
		baseStats: {hp: 98, atk: 68, def: 74, spa: 108, spd: 84, spe: 92}, 
		abilities: {0: "Scary Boost"}, 
		weightkg: 27.6, 
	}, 
	pansicott: {
		num: 9.8, 
		name: "Pansicott", 
		fusion: ["Whimsicott", "Pangoro"], 
		types: ["Grass", "Dark"], 
		baseStats: {hp: 87, atk: 105, def: 91, spa: 73, spd: 83, spe: 87}, 
		abilities: {0: "Mold Prankster"}, 
		weightkg: 71.3, 
	}, 
